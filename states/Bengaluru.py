...
class Bengaluru(State):
    ...
    def get_data_from_source(self):
        ...
        finaldf.columns = ['sno', 'HOSPITAL_NAME', 'ALLOCATED_BEDS_GEN',
                           ...
                           'ALLOCATED_BEDS_TOTAL', 'OCCUPIED_BEDS_GEN', 'OCCUPIED_BEDS_HDU',
                           'OCCUPIED_BEDS_ICU',
                           'OCCUPIED_BEDS_VENT', 'OCCUPIED_BEDS_TOTAL', 'AVAILABLE_BEDS_GEN',
                           'AVAILABLE_BEDS_HDU', 'AVAILABLE_BEDS_ICU',
